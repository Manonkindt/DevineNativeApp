...
// UIFont-Enumerate
#define COCOAPODS_POD_AVAILABLE_UIFont_Enumerate
#define COCOAPODS_VERSION_MAJOR_UIFont_Enumerate 1
#define COCOAPODS_VERSION_MINOR_UIFont_Enumerate 0
#define COCOAPODS_VERSION_PATCH_UIFont_Enumerate 9
